...
public class TreeMap01 {
    ...
    /*
        1) TreeMap'ler entrySet'leri key'lere gore "natural order(alfabetik)" da siralar.
    ...
    public static void main(String[] args) {
        ...
        // tailMap() yazdiginiz key'den baslayarak sona kadar tum entry'leri size verir.
        ...
        // tailMap(String, false) yazdiginiz key'den baslayarak sona kadar tum entry'leri size verir. ama sizin verdiginiz key'i haric tutar.
        ...
        System.out.println(map9);// null ==> Cunku Tom Hanks'den sonra eleman yok.

        // ceilingEntry("Mary Star") var olan key ile kullanirsa o key'i verir. Var olmayan bir key ile kullanirsa bir sonrakini verir.
        ...
        // floorEntry("Mary Star")  var olan key ile kullanirsa o key'i verir. Var olmayan bir key ile kullanirsa bir oncekini verir.

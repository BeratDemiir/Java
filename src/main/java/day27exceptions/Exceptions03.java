...
public class Exceptions03 {
    ...
    /*
       ...
       5) Custom "RunTimeException" uretmek icin "extend RunTimeException" ederiz.
       6) Custom "CompileTimeException" uretmek icin "extend Exception" ederiz.
     */

    public static void main(String[] args) throws IllegalGradeException {

        printGrades(12);
        checkNameFormat("Berat");
    }
